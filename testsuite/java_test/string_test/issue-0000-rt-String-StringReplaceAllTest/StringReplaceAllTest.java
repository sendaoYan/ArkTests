...
//        System.out.println("processResult:" + processResult);
    ...
    public static void StringReplaceAllTest_1() {
        String testCaseID = "StringReplaceAllTest_1";
...
//        test(str2_5);
        ...
        System.out.println(str3_1.replaceAll("[ab][bc][cd]", "@@@"));
        String str4_1 = "abc$123ABC-abc$123ABC";
        System.out.println(str4_1.replaceAll("\\$", "@"));
        String str5_1 = "2018-01-02-2018-01-02";
        System.out.println(str5_1.replaceAll("\\d{4}", "@@@@"));
        String str6_1 = "abc123\rABC-abc123\rABC";
        System.out.println(str6_1.replaceAll("\\\r", "@"));
        String str7_1 = "abc123ABC-abc123ABC";
        System.out.println(str7_1.replaceAll("^abc", "@@@"));
    }
