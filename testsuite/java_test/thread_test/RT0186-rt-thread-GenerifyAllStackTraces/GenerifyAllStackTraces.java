...
// EXEC:%maple  GenerifyAllStackTraces.java -p %platform %build_option -o %n.so
// EXEC:%run -b %host -l %username -p %port --run_type %run_type --sn %sn  %n.so GenerifyAllStackTraces  %mplsh_option| compare %f
// ASSERT: scan 0\n0\n
