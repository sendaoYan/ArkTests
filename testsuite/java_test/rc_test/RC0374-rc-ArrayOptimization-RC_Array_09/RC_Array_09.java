...
public class RC_Array_09 extends Base_009{
    ...
    public static void main(String[] args) {
        ...
        if(TEST1.length == 4 && TEST2.length == 3 && TEST3.length == 2
            ...
            throw new RuntimeException("ErrorResult double step1");
    ...
    private static double[][] RC_Array_09_test01()
    {
        ...
        if(rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_09_test01");
    ...
    private static double[][] RC_Array_09_test02()
    {
        ...
        if(rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_09_test02");
        rctest.base1 = VALUE1;
        rctest.base2 = VALUE2;
        ...
        if(rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_09_test02_2");
        return VALUE2;
    }
