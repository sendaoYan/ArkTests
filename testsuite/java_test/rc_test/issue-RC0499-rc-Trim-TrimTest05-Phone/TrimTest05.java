...
public class TrimTest05 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        input.close();
        store = null;
        if (Integer.valueOf(rosInfo) > MEMORY_LIMIT * 1024 && Integer.valueOf(rosInfo2) > 11 * 1024 &&
            Integer.valueOf(rosInfo2) < 15.2 * 1024) {
