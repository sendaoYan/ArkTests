...
public class TrimTest11 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        input.close();
        store = null;
        if (Integer.valueOf(rosInfo) > MEMORY_LIMIT * 1024 && Integer.valueOf(rosInfo2) > 89 * 1024 &&
            Integer.valueOf(rosInfo2) < 94.5 * 1024) {
