...
public class TrimTest04 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        input.close();
        if (Integer.valueOf(rosInfo) > MEMORY_LIMIT * 1024 && Integer.valueOf(rosInfo2) < 3.2 * 1024) {
