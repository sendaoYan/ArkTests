...
public class RC_Array_08 extends Base_008{
    ...
    public static void main(String[] args) {
        ...
        if(TEST1.length == 4 && TEST2.length == 3 && TEST3.length == 2
            ...
            throw new RuntimeException("ErrorResult float step1");
    ...
    private static float[][] RC_Array_08_test01()
    {
        ...
        if(rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_08_test01");
    ...
    private static float[][] RC_Array_08_test02()
    {
        ...
        if(rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_08_test02");
        rctest.base1 = VALUE1;
        rctest.base2 = VALUE2;
        ...
        if(rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_08_test02_2");
        return VALUE2;
    }
