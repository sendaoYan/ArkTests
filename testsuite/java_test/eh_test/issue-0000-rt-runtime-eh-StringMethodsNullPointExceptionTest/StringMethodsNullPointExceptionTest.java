...
public class StringMethodsNullPointExceptionTest {
...
;
    ...
    */
    ...
    public static void stringMethodsNullPointExceptionTest() {
        String str1 = "abc123";
        String str2 = null;
        test0(str1);
        test1(str2);
    ...
    private static void test1(String str) {
        try {
            ...
            System.out.println("======Please check below information as manual======");
