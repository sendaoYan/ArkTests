 ...
 * -@TestCaseID: UnsafeputShortTest
 * -@TestCaseName: Unsafe api: putShort()
 ...
 * -#step3:set value of step2 by Unsafe.putShort
 * -#step4:check value of step3 correct
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: UnsafeputShortTest.java
 * -@ExecuteClass: UnsafeputShortTest
 * -@ExecuteArgs:
 */
...
public class UnsafeputShortTest {
    ...
    private static int run(String[] args, PrintStream out) {
        ...
        try {
            ...
            e.printStackTrace();
            UnsafeputShortTest.res -= 2;
        }

        if (result == 3 && UnsafeputShortTest.res == 97) {
            result =0;
        }
        return result;
    }
    ...
    private static int UnsafegetShortTest_1() {
        ...
        try {
            ...
            param = Billie28.class.getDeclaredField("date");
