 ...
 * -@TestCaseName: Unsafe api: getChar()
 ...
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: UnsafegetCharTest.java
 * -@ExecuteClass: UnsafegetCharTest
 * -@ExecuteArgs:
 */
...
public class UnsafegetCharTest {
    ...
    private static int run(String[] args, PrintStream out) {
        ...
        try {
            result = UnsafegetCharTest_1();
        } catch (Exception e) {
            e.printStackTrace();
            UnsafegetCharTest.res -= 2;
        }

        if (result == 3 && UnsafegetCharTest.res == 97) {
            result =0;
        }
        return result;
    }

    private static int UnsafegetCharTest_1() {
        Unsafe unsafe;
        Field field;
        Long offset;
        Field param;
        ...
        try {
            ...
            param = Billie25.class.getDeclaredField("favorite");
