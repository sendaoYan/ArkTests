 ...
 * -@TestCaseID: UnsafeputIntVolatileTest
 * -@TestCaseName: Unsafe api: putIntvolatile()
 * -@TestCaseType: Function Test
 * -@RequirementName: VMRuntime_registerNativeAllocation接口实现
 * -@Brief:
 * -#step1:prepare one Class and get Field of Volatile Int
 * -#step2:invoke Unsafe.getIntVolatile to visit this Field
 * -#step3:set value of step2 by Unsafe.putIntVolatile
 * -#step4:check value of step3 correct
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: UnsafeputIntVolatileTest.java
 * -@ExecuteClass: UnsafeputIntVolatileTest
 * -@ExecuteArgs:
 */
