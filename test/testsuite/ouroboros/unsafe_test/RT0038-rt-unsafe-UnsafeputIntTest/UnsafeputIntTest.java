 ...
 * -@TestCaseID: UnsafeputIntTest
 * -@TestCaseName: Unsafe api: putInt()
 ...
 * -#step3:set value of step2 by Unsafe.putInt
 * -#step4:check value of step3 correct
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: UnsafeputIntTest.java
 * -@ExecuteClass: UnsafeputIntTest
 * -@ExecuteArgs:
 */
