 ...
 * -@TestCaseID: UnsafeputBooleanTest
 * -@TestCaseName: Unsafe api: putBoolean()
 ...
 * -#step3:set value of step2 by Unsafe.putBoolean
 * -#step4:check value of step3 correct
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: UnsafeputBooleanTest.java
 * -@ExecuteClass: UnsafeputBooleanTest
 * -@ExecuteArgs:
 */
...
public class UnsafeputBooleanTest {
    ...
    private static int run(String[] args, PrintStream out) {
        ...
        try {
            result = UnsafeputBooleanTest_1();
        } catch (Exception e) {
            e.printStackTrace();
            UnsafeputBooleanTest.res -= 2;
        }

        if (result == 3 && UnsafeputBooleanTest.res == 97) {
            result =0;
        }
        return result;
    }

    private static int UnsafeputBooleanTest_1() {
        Unsafe unsafe;
        Field field;
        Long offset;
        Field param;
        ...
        try {
            ...
            param = Billie22.class.getDeclaredField("gender");
