 ...
 * -@TestCaseName: Unsafe api: getDouble()
 ...
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: UnsafegetDoubleTest.java
 * -@ExecuteClass: UnsafegetDoubleTest
 * -@ExecuteArgs:
 */
...
public class UnsafegetDoubleTest {
    ...
    private static int run(String[] args, PrintStream out) {
        ...
        try {
            result = UnsafegetDoubleTest_1();
        } catch (Exception e) {
            e.printStackTrace();
            UnsafegetDoubleTest.res -= 2;
        }

        if (result == 3 && UnsafegetDoubleTest.res == 97) {
            result =0;
        }
        return result;
    }

    private static int UnsafegetDoubleTest_1() {
        Unsafe unsafe;
        Field field;
        Long offset;
        Field param;
        ...
        try {
            ...
            param = Billie29.class.getDeclaredField("grade");
