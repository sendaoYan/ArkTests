 ...
 * -@TestCaseID: FieldgetFloatExceptionInInitializerError.java
 * -@TestCaseName: Exception in reflect filed:public float getFloat(Object obj)
 * -@TestCaseType: Function Test
 * -@RequirementName: [运行时需求]支持Java异常处理
 * -@Brief:
 * -#step1:prepare Class have wrong init order
 * -#step2:trigger class init by Field.getFloat
 * -#step3:catch EH
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: FieldgetFloatExceptionInInitializerError.java
 * -@ExecuteClass: FieldgetFloatExceptionInInitializerError
 * -@ExecuteArgs:
 */
