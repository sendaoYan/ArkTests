 ...
 * -@TestCaseID: MonitorTestCase2.java
 *- @TestCaseName: Thread_MonitorTestCase2.java
 ...
 * -#step2: 分配INIT_DEFAULT_THREAD_NUM / 2个对象来自于new StopAbleThread类，同时启动监控线程,监控进程解锁后等待sleepTime时间。
 ...
 *- @Expect: 0\n
 *- @Priority: High
 *- @Source: MonitorTestCase2.java
 *- @ExecuteClass: MonitorTestCase2
 *- @ExecuteArgs:
 */
