 ...
 *- @Title/Destination: Test sleep with out interrupt
 *- @Brief: see below
 * -#step1: Sleep current thread by calling Thread.sleep().
 * -#step2: Check that current thread was slept.
 *- @Expect: expected.txt
 *- @Priority: High
...
public class ThreadTest {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Test sleep(long millis) OK --");
    }
}
