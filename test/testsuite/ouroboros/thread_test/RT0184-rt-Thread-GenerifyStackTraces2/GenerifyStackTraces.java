 ...
 * -@TestCaseID: getStackTrace_RecursiveCall
 *- @TestCaseName: GenerifyStackTraces.java
 *- @RequirementName: Java Thread
 *- @Title/Destination: Generified basic unit test of Thread.getStackTraces()
 *- @Brief: see below
 * -#step1： 定义ThreadOne类，该类继承Thread类，定义run函数，会调用wait()方法依次调用A,B,C,Done方法，最后获取当前线程的栈信
 *           息，并检查。
