/* @test */
/*
 *- @TestCaseID:rc/stress/Memory_normalTestCase10.java
 ...
 *- @Expect:
 *- @Priority: High
 *- @Source: Memory_normalTestCase10.java
 *- @ExecuteClass: Memory_normalTestCase10
 *- @ExecuteArgs:
 *- @Remark:
...
public class Memory_normalTestCase10 {
    ...
    public static void testCase10() {
        ...
        for (int i = 0; i < DEFAULT_THREAD_NUM; i++) {
            ...
            t = new Thread(new MemAlloc(ALLOC_16K, slot, mAllThreadReference, i, MemAlloc.SAVE_ALL, false, 1), "testCase10_" + (i + 1));
            list.add(t);
        }
        startAllThread(list);
