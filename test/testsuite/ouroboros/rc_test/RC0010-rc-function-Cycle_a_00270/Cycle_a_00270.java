/* @test */
/*
 *- @TestCaseID:maple/runtime/rc/function/Cycle_a_00270.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Cycle_a_00270 in RC测试-Cycle-01
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_a_00270.java
 *- @ExecuteClass: Cycle_a_00270
 *- @ExecuteArgs:
 *- @Remark:
 *  A1 depend A2 A3;  A6 depend A3
 * A2 depend A3; A3 depend A1 A5; A5 depend A6;
 * A1.a=101 A2.a=102 A3.a=103 ... A9.a=109
 * RC-Testing_Result=(101+102+103)+(102+103)+(103+101+105)+(105+106)+(106+103)=1240
 *
 */
