 ...
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: Alloc_Threadm_128x8B_2.java
 *- @ExecuteClass: Alloc_Threadm_128x8B_2
 *- @ExecuteArgs:
 *- @Remark:
 */
import java.util.ArrayList;

class Alloc_Threadm_128x8B_2_01 extends Thread {
...
public class Alloc_Threadm_128x8B_2 {
    public static void main(String[] args){
        Alloc_Threadm_128x8B_2_01 test1=new Alloc_Threadm_128x8B_2_01();
        test1.start();
        Alloc_Threadm_128x8B_2_01 test2=new Alloc_Threadm_128x8B_2_01();
        test2.start();
        Alloc_Threadm_128x8B_2_01 test3=new Alloc_Threadm_128x8B_2_01();
        test3.start();
        Alloc_Threadm_128x8B_2_01 test4=new Alloc_Threadm_128x8B_2_01();
        test4.start();
        Alloc_Threadm_128x8B_2_01 test5=new Alloc_Threadm_128x8B_2_01();
        test5.start();
        Alloc_Threadm_128x8B_2_01 test6=new Alloc_Threadm_128x8B_2_01();
        test6.start();
        try{
            test1.join();
            test2.join();
