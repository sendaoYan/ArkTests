/* @test */
/*
 *- @TestCaseID:rc/stress/Memory_normalTestCase8.java
 ...
 *- @Expect:
 *- @Priority: High
 *- @Source: Memory_normalTestCase8.java
 *- @ExecuteClass: Memory_normalTestCase8
 *- @ExecuteArgs:
 *- @Remark:
...
public class Memory_normalTestCase8 {
    ...
    public static void testCase8() {
        ...
        for (int i = 0; i < DEFAULT_THREAD_NUM; i++) {
            ...
            t = new Thread(new MemAlloc(ALLOC_8K + ALLOC_4K, slot, mAllThreadReference, i, MemAlloc.SAVE_ALL, false, 1), "testCase8_" + (i + 1));
            list.add(t);
        }
        startAllThread(list);
