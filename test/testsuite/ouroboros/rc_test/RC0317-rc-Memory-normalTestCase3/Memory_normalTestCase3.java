/* @test */
/*
 * -@TestCaseID:rc/stress/Memory_normalTestCase3.java
 ...
 * -@Expect:
 * -@Priority: High
 * -@Source: Memory_normalTestCase3.java
 * -@ExecuteClass: Memory_normalTestCase3
 * -@ExecuteArgs:
 * -@Remark:
...
public class Memory_normalTestCase3 {
    ...
    public static void wrapper() {
        ...
        for (int i = 0; i < DEFAULT_THREAD_NUM; i++) {
            slot = i % MAX_SLOT_NUM;
            Runnable remain = new MemAlloc(ALLOC_2K, slot, allThreadReference, i, MemAlloc.SAVE_HALF_RAMDOM, true, 1);
            t = new Thread(new MemAlloc(ALLOC_4K, slot, allThreadReference, i, MemAlloc.SAVE_HALF, false,
                1, DEFAULT_REPEAT_TIMES, remain), "testCase3_" + (i + 1));
            list.add(t);
        }
        startAllThread(list);
