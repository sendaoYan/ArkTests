/* @test */
/*
 *- @TestCaseID:maple/runtime/rc/function/RC_Thread01/Cycle_am_00490.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Cycle_a_00490 in RC测试-Cycle-01 to Multi thread testcase.
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\nExpectResult\nExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_am_00490.java
 *- @ExecuteClass: Cycle_am_00490
 *- @ExecuteArgs:
 *- @Remark:
 */
class ThreadRc_Cycle_am_00490 extends Thread {
...
public class Cycle_am_00490 {
    ...
    private static void rc_testcase_main_wrapper() {
        ThreadRc_Cycle_am_00490 A1_Cycle_am_00490 = new ThreadRc_Cycle_am_00490();
        ThreadRc_Cycle_am_00490 A2_Cycle_am_00490 = new ThreadRc_Cycle_am_00490();
        ThreadRc_Cycle_am_00490 A3_Cycle_am_00490 = new ThreadRc_Cycle_am_00490();
        ThreadRc_Cycle_am_00490 A4_Cycle_am_00490 = new ThreadRc_Cycle_am_00490();
        ThreadRc_Cycle_am_00490 A5_Cycle_am_00490 = new ThreadRc_Cycle_am_00490();
        ThreadRc_Cycle_am_00490 A6_Cycle_am_00490 = new ThreadRc_Cycle_am_00490();

        A1_Cycle_am_00490.start();
        A2_Cycle_am_00490.start();
        A3_Cycle_am_00490.start();
        A4_Cycle_am_00490.start();
        A5_Cycle_am_00490.start();
        A6_Cycle_am_00490.start();

        try {
            A1_Cycle_am_00490.join();
            A2_Cycle_am_00490.join();
            A3_Cycle_am_00490.join();
            A4_Cycle_am_00490.join();
            A5_Cycle_am_00490.join();
            A6_Cycle_am_00490.join();

        } catch (InterruptedException e) {
        }
        if (A1_Cycle_am_00490.check() && A2_Cycle_am_00490.check() && A3_Cycle_am_00490.check() && A4_Cycle_am_00490.check() && A5_Cycle_am_00490.check() && A6_Cycle_am_00490.check())
