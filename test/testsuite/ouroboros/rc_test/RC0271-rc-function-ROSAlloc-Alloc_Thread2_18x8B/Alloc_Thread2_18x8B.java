/* @test */
/*
 *- @TestCaseID:Alloc_Thread2_18x8B
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title:ROS Allocator is in charge of applying and releasing objects.This mulit thread testcase is mainly for testing objects from 8B to 18*8B(max) with 2 threads.
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: Alloc_Thread2_18x8B.java
 *- @ExecuteClass: Alloc_Thread2_18x8B
 *- @ExecuteArgs:
 *- @Remark:
 */
