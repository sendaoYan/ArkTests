/* @test */
/*
 *- @TestCaseID:rc/stress/Memory_normalTestCase17.java
 ...
 *- @Expect:
 *- @Priority: High
 *- @Source: Memory_normalTestCase17.java
 *- @ExecuteClass: Memory_normalTestCase17
 *- @ExecuteArgs:
 *- @Remark:
...
public class Memory_normalTestCase17 {
    ...
    public static void testCase17() {
        ...
        for (int i = 0; i < 2 * DEFAULT_THREAD_NUM; i++) {
            ...
            RandomAllocMethod allocMethod = new RandomAllocMethod(ALLOC_4K * 6, ENUM_RANGE.ENUM_RANGE_ALL, 6, 0, false);
            t = new Thread(new MemAlloc(ALLOC_4K * 6, slot, mAllThreadReference, i, MemAlloc.SAVE_ALL, false, 1, DEFAULT_REPEAT_TIMES, null, allocMethod), "testCase17_alloc_" + (i + 1));
            list.add(t);
        }
        startAllThread(list);
