/* @test */
/*
 *- @TestCaseID:maple/runtime/rc/function/Cycle_B_2_00200.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Cycle_B_2_00200 in RC测试-Cycle-00.vsd.
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_B_2_00200.java
 *- @ExecuteClass: Cycle_B_2_00200
 *- @ExecuteArgs:
 *- @Remark:
 */
