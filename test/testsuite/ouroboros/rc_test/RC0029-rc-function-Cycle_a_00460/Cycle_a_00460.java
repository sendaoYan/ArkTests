...
/*
 *- @TestCaseID:maple/runtime/rc/function/Cycle_a_00460.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Cycle_a_00460 in RC测试-Cycle-01
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_a_00460.java
 *- @ExecuteClass: Cycle_a_00460
 *- @ExecuteArgs:
 *- @Remark:
 * A1 depend A2 A4 ; A2 depend A3 ; A3 depend A4 ; A4 depend A1 A6
 * A5 depend A3 ; A6 depend A1 A5
 * A1.a=101 A2.a=102 A3.a=103 ... A6.a=106
 * RC-Testing_Result=(101+102+104)+(102+103)+(103+104)+(104+106+101)+(105+103)+(106+105+101)=1550
 *
 */
