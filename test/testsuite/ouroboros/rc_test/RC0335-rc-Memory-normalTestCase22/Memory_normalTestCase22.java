/* @test */
/*
 *- @TestCaseID:rc/stress/Memory_normalTestCase22.java
 ...
 *- @Expect:
 *- @Priority: High
 *- @Source: Memory_normalTestCase22.java
 *- @ExecuteClass: Memory_normalTestCase22
 *- @ExecuteArgs:
 *- @Remark:
...
public class Memory_normalTestCase22 {
    ...
    public static void testCase22() {
        ...
        for (int i = 0; i < DEFAULT_THREAD_NUM; i++) {
            ...
            t = new Thread(new MemAlloc(size, slot, mAllThreadReference, i % DEFAULT_THREAD_NUM_HALF, MemAlloc.SAVE_ALL, true, 1000, DEFAULT_REPEAT_TIMES, null, allocMethod), "testCase22_alloc_" + (i + 1));
            list.add(t);
        }
        for (int i = 0; i < DEFAULT_THREAD_NUM; i++) {
            int slot = new Random().nextInt(MAX_SLOT_NUM);
