/* @test */
/*
 *- @TestCaseID:maple/runtime/rc/function/RC_Thread01/Cycle_am_00380.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Cycle_a_00380 in RC测试-Cycle-01 to Multi thread testcase.
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_am_00380.java
 *- @ExecuteClass: Cycle_am_00380
 *- @ExecuteArgs:
 *- @Remark:
 */
