/* @test */
/*
 *- @TestCaseID:maple/runtime/rc/optimization/RC_Array_10.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Scenario test for RC optimization: test array copy object various scenarios, including:
 *                   1.One, two, three-dimensional array type cyclic assignment
 *                   2.One, two, three-dimensional array type System.arraycopy () assignment
 *                   3.One, two, three-dimensional array type Arrays.copyOf() assignment
 *                   4.One, two, three-dimensional array type Arrays.copyOfRange() assignment
 *                   5.One, two, three-dimensional array type clone() assignment
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: RC_Array_10.java
 *- @ExecuteClass: RC_Array_10
 *- @ExecuteArgs:
 *- @Remark:
 */
