/* @test */
/*
 *- @TestCaseID:maple/runtime/rc/function/Nocycle_a_00180.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Nocycle_a_00180 in RC测试-No-Cycle-00.vsd.
 *- @Condition: no
 * -#c1
 *- @Brief:functionTest
 * -#step1
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Nocycle_a_00180.java
 *- @ExecuteClass: Nocycle_a_00180
 *- @ExecuteArgs:
 *- @Remark:
 */
