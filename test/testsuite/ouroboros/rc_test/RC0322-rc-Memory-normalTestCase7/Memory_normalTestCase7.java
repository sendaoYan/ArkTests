/* @test */
/*
 *- @TestCaseID:rc/stress/Memory_normalTestCase7.java
 ...
 *- @Expect:
 *- @Priority: High
 *- @Source: Memory_normalTestCase7.java
 *- @ExecuteClass: Memory_normalTestCase7
 *- @ExecuteArgs:
 *- @Remark:
...
public class Memory_normalTestCase7 {
    ...
    public static void testCase7() {
        ...
        for (int i = 0; i < DEFAULT_THREAD_NUM; i++) {
            ...
            t = new Thread(new MemAlloc(ALLOC_8K + getSlotSize(slot), slot, mAllThreadReference, i, MemAlloc.SAVE_ALL, false, 1), "testCase7_" + (i + 1));
            list.add(t);
        }
        startAllThread(list);
