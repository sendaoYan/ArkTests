/* @test */
/*
 * -@TestCaseID:PlacementRCTest04.java
 * -@TestCaseName:MyselfClassName
 * -@RequirementName:[运行时需求]支持自动内存管理
 * -@Title/Destination:检测在多层try-catch的语句中，生命周期结束的局部对象，应该会被立即回收
 * 检测在eh中，生命周期结束的对象，应该会被立即回收
 * -@Condition: no
 * -#c1
 * -@Brief:functionTest
 * -#step1：run（）方法就是多层try-catch嵌套，里面有一些局部对象，声明周期到了之后会被立即释放
 * -@Expect:ExpectResult\n
 * -@Priority: High
 * -@Source: PlacementRCTest04.java
 * -@ExecuteClass: PlacementRCTest04
 * -@ExecuteArgs:
 * -@Remark:
 */
