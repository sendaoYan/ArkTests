 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/Cycle_am_00350.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Cycle_a_00350 in RC测试-Cycle-01 to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_am_00350.java
 *- @ExecuteClass: Cycle_am_00350
 *- @ExecuteArgs:
 */

class ThreadRc_Cycle_am_00350 extends Thread {
...
public class Cycle_am_00350 {
    ...
    private static void rc_testcase_main_wrapper() {
        ThreadRc_Cycle_am_00350 A1_Cycle_am_00350 = new ThreadRc_Cycle_am_00350();
        ThreadRc_Cycle_am_00350 A2_Cycle_am_00350 = new ThreadRc_Cycle_am_00350();
        ThreadRc_Cycle_am_00350 A3_Cycle_am_00350 = new ThreadRc_Cycle_am_00350();
        ThreadRc_Cycle_am_00350 A4_Cycle_am_00350 = new ThreadRc_Cycle_am_00350();
        ThreadRc_Cycle_am_00350 A5_Cycle_am_00350 = new ThreadRc_Cycle_am_00350();
        ThreadRc_Cycle_am_00350 A6_Cycle_am_00350 = new ThreadRc_Cycle_am_00350();

        A1_Cycle_am_00350.start();
        A2_Cycle_am_00350.start();
        A3_Cycle_am_00350.start();
        A4_Cycle_am_00350.start();
        A5_Cycle_am_00350.start();
        A6_Cycle_am_00350.start();

        try {
            A1_Cycle_am_00350.join();
            A2_Cycle_am_00350.join();
            A3_Cycle_am_00350.join();
            A4_Cycle_am_00350.join();
            A5_Cycle_am_00350.join();
            A6_Cycle_am_00350.join();

        } catch (InterruptedException e) {
        }
        if (A1_Cycle_am_00350.check() && A2_Cycle_am_00350.check() && A3_Cycle_am_00350.check() && A4_Cycle_am_00350.check() && A5_Cycle_am_00350.check() && A6_Cycle_am_00350.check())
