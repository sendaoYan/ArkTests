 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/Cycle_am_00360.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Cycle_a_00360 in RC测试-Cycle-01 to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_am_00360.java
 *- @ExecuteClass: Cycle_am_00360
 *- @ExecuteArgs:
 */

class ThreadRc_Cycle_am_00360 extends Thread {
...
public class Cycle_am_00360 {
    ...
    private static void rc_testcase_main_wrapper() {
        ThreadRc_Cycle_am_00360 A1_Cycle_am_00360 = new ThreadRc_Cycle_am_00360();
        ThreadRc_Cycle_am_00360 A2_Cycle_am_00360 = new ThreadRc_Cycle_am_00360();
        ThreadRc_Cycle_am_00360 A3_Cycle_am_00360 = new ThreadRc_Cycle_am_00360();
        ThreadRc_Cycle_am_00360 A4_Cycle_am_00360 = new ThreadRc_Cycle_am_00360();
        ThreadRc_Cycle_am_00360 A5_Cycle_am_00360 = new ThreadRc_Cycle_am_00360();
        ThreadRc_Cycle_am_00360 A6_Cycle_am_00360 = new ThreadRc_Cycle_am_00360();

        A1_Cycle_am_00360.start();
        A2_Cycle_am_00360.start();
        A3_Cycle_am_00360.start();
        A4_Cycle_am_00360.start();
        A5_Cycle_am_00360.start();
        A6_Cycle_am_00360.start();

        try {
            A1_Cycle_am_00360.join();
            A2_Cycle_am_00360.join();
            A3_Cycle_am_00360.join();
            A4_Cycle_am_00360.join();
            A5_Cycle_am_00360.join();
            A6_Cycle_am_00360.join();

        } catch (InterruptedException e) {
        }
        if (A1_Cycle_am_00360.check() && A2_Cycle_am_00360.check() && A3_Cycle_am_00360.check() && A4_Cycle_am_00360.check() && A5_Cycle_am_00360.check() && A6_Cycle_am_00360.check())
