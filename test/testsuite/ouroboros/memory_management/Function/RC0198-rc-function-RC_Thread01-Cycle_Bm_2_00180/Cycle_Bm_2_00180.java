 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/Cycle_Bm_2_00180.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Cycle_B_2_00180 in RC测试-Cycle-00.vsd to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_Bm_2_00180.java
 *- @ExecuteClass: Cycle_Bm_2_00180
 *- @ExecuteArgs:
 */
class ThreadRc_Cycle_Bm_2_00180 extends Thread {
...
public class Cycle_Bm_2_00180 {
    ...
    private static void rc_testcase_main_wrapper() {
        ...
        A1_Cycle_Bm_2_00180.start();
        A2_Cycle_Bm_2_00180.start();
        A3_Cycle_Bm_2_00180.start();
        A4_Cycle_Bm_2_00180.start();
        A5_Cycle_Bm_2_00180.start();
        A6_Cycle_Bm_2_00180.start();

        try {
            A1_Cycle_Bm_2_00180.join();
            A2_Cycle_Bm_2_00180.join();
            A3_Cycle_Bm_2_00180.join();
            A4_Cycle_Bm_2_00180.join();
            A5_Cycle_Bm_2_00180.join();
            A6_Cycle_Bm_2_00180.join();

        } catch (InterruptedException e) {
        }
        if (A1_Cycle_Bm_2_00180.check() && A2_Cycle_Bm_2_00180.check() && A3_Cycle_Bm_2_00180.check() && A4_Cycle_Bm_2_00180.check() && A5_Cycle_Bm_2_00180.check() && A6_Cycle_Bm_2_00180.check())
