 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/Nocycle_am_00150.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Nocycle_a_00150 in RC测试-No-Cycle-00.vsd to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Nocycle_am_00150.java
 *- @ExecuteClass: Nocycle_am_00150
 *- @ExecuteArgs:
 */
