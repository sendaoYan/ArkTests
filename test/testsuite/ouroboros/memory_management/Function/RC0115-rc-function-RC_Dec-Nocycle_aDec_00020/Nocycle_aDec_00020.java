 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Dec/Nocycle_aDec_00020.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Nocycle_aDec_00020 in RC测试-No-Cycle-00.vsd.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Nocycle_aDec_00020.java
 *- @ExecuteClass: Nocycle_aDec_00020
 *- @ExecuteArgs:
 */
