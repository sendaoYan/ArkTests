 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Dec/Cycle_BDec_00050.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Cycle_BDec_00050 in RC测试-Cycle-00.vsd
 *- @Brief:functionTest
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_BDec_00050.java
 *- @ExecuteClass: Cycle_BDec_00050
 *- @ExecuteArgs:
 */
