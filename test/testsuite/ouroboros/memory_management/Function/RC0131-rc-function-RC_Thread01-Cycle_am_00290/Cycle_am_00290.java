 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/Cycle_am_00290.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Cycle_a_00290 in RC测试-Cycle-01 to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_am_00290.java
 *- @ExecuteClass: Cycle_am_00290
 *- @ExecuteArgs:
 */

class ThreadRc_Cycle_am_00290 extends Thread {
...
public class Cycle_am_00290 {
    ...
    private static void rc_testcase_main_wrapper() {
        ThreadRc_Cycle_am_00290 A1_Cycle_am_00290 = new ThreadRc_Cycle_am_00290();
        ThreadRc_Cycle_am_00290 A2_Cycle_am_00290 = new ThreadRc_Cycle_am_00290();
        ThreadRc_Cycle_am_00290 A3_Cycle_am_00290 = new ThreadRc_Cycle_am_00290();
        ThreadRc_Cycle_am_00290 A4_Cycle_am_00290 = new ThreadRc_Cycle_am_00290();
        ThreadRc_Cycle_am_00290 A5_Cycle_am_00290 = new ThreadRc_Cycle_am_00290();
        ThreadRc_Cycle_am_00290 A6_Cycle_am_00290 = new ThreadRc_Cycle_am_00290();

        A1_Cycle_am_00290.start();
        A2_Cycle_am_00290.start();
        A3_Cycle_am_00290.start();
        A4_Cycle_am_00290.start();
        A5_Cycle_am_00290.start();
        A6_Cycle_am_00290.start();

        try {
            A1_Cycle_am_00290.join();
            A2_Cycle_am_00290.join();
            A3_Cycle_am_00290.join();
            A4_Cycle_am_00290.join();
            A5_Cycle_am_00290.join();
            A6_Cycle_am_00290.join();

        } catch (InterruptedException e) {
        }
        if (A1_Cycle_am_00290.check() && A2_Cycle_am_00290.check() && A3_Cycle_am_00290.check() && A4_Cycle_am_00290.check() && A5_Cycle_am_00290.check() && A6_Cycle_am_00290.check())
