 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/Nocycle_am_00050.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Nocycle_a_00050 in RC测试-No-Cycle-00.vsd to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Nocycle_am_00050.java
 *- @ExecuteClass: Nocycle_am_00050
 *- @ExecuteArgs:
 */
class ThreadRc_00050 extends Thread {
...
public class Nocycle_am_00050 {
    ...
    private static void rc_testcase_main_wrapper() {
        ThreadRc_00050 A1_00050 = new ThreadRc_00050();
        ThreadRc_00050 A2_00050 = new ThreadRc_00050();
        ThreadRc_00050 A3_00050 = new ThreadRc_00050();
        ThreadRc_00050 A4_00050 = new ThreadRc_00050();
        ThreadRc_00050 A5_00050 = new ThreadRc_00050();
        ThreadRc_00050 A6_00050 = new ThreadRc_00050();
        ...
        if (A1_00050.check() && A2_00050.check() && A3_00050.check() && A4_00050.check() && A5_00050.check() && A6_00050.check())
