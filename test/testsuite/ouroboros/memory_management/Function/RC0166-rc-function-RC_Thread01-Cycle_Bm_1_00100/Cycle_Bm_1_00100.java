 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/Cycle_Bm_1_00100.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change Cycle_B_1_00100 in RC测试-Cycle-00.vsd to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\nExpectResult\n
 *- @Priority: High
 *- @Source: Cycle_Bm_1_00100.java
 *- @ExecuteClass: Cycle_Bm_1_00100
 *- @ExecuteArgs:
 */
