 ...
 * -@TestCaseID:maple/runtime/rc/function/RC_Thread01/RCAnnotationTwoCycleThread.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination:Change RCAnnotationTwoCycle to Multi thread testcase.
 *- @Brief:functionTest
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: RCAnnotationTwoCycleThread.java
 *- @ExecuteClass: RCAnnotationTwoCycleThread
 *- @ExecuteArgs:
 */
...
public class RCAnnotationTwoCycleThread {
