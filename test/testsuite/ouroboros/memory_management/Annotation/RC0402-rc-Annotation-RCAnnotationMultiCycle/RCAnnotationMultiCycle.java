 ...
 * -@TestCaseID:maple/runtime/rc/function/RCAnnotationMultiCycle.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Cycle_a_00280 for @Weak and @Unowned Test
 *- @Brief:functionTest
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: RCAnnotationMultiCycle.java
 *- @ExecuteClass: RCAnnotationMultiCycle
 *- @ExecuteArgs:
 *  A1 depend A2 A3;  A6 depend A3
 * A2 depend A1 A3; A3 depend A1 A5; A5 depend A6;
 * A1.a=101 A2.a=102 A3.a=103 ... A9.a=109
 * RC-Testing_Result=(101+102+103)+(102+101+103)+(103+101+102+105)+(105+106)+(106+103)=1443
 *
 */
...
public class RCAnnotationMultiCycle {
