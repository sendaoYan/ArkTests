 ...
 * -@TestCaseID:maple/runtime/rc/function/RCUnownedRefUncycle02.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Nocycle_a_00180 for @Unowned Test
 *- @Brief:functionTest
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: RCUnownedRefUncycle02.java
 *- @ExecuteClass: RCUnownedRefUncycle02
 *- @ExecuteArgs:
 */
...
public class RCUnownedRefUncycle02 {
