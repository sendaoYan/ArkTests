 ...
 * -@TestCaseID:maple/runtime/rc/optimization/RC_Array_04.java
 *- @TestCaseName:MyselfClassName
 *- @RequirementName:[运行时需求]支持自动内存管理
 *- @Title/Destination: Scenario testing for RC optimization: testing various scenes of 1D, 2D, 3D boolean array objects，including：
 ...
 *- @Expect:ExpectResult\n
 *- @Priority: High
 *- @Source: RC_Array_04.java
 *- @ExecuteClass: RC_Array_04
 *- @ExecuteArgs:
 */
...
public class RC_Array_04 extends Base_004 {
    ...
    public static void main(String[] args) {
        ...
        if (TEST1.length == 4 && TEST2.length == 3 && TEST3.length == 2
            ...
            throw new RuntimeException("ErrorResult boolean step1");
    ...
    private static boolean[][] RC_Array_04_test01() {
        ...
        if (rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_04_test01");
    ...
    private static boolean[][] RC_Array_04_test02() {
        ...
        if (rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_04_test02");
        rctest.base1 = VALUE1;
        rctest.base2 = VALUE2;
        ...
        if (rctest.base1.length == 4 && rctest.base2.length == 3 && rctest.base21.length == 3 && rctest.base3.length == 2)
            ...
            throw new RuntimeException("ErrorResult in RC_Array_04_test02_2");
        return VALUE2;
    }
