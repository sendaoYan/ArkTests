 ...
 * -@TestCaseID: StringGetBytesTest.java
 * -@TestCaseName: Test String Method: byte[] getBytes().
 * -@TestCaseType: Function Test
 * -@RequirementName: Java字符串实现
 * -@Brief:
 * -#step1: Create String instance.
 * -#step2: Test method getBytes().
 * -#step3: Check the return byte[] is correctly.
 * -#step4: Change instance as One or more kinds of letters, numbers, special symbols to repeat step2~3.
 * -@Expect: expected.txt
 * -@Priority: High
 * -@Source: StringGetBytesTest.java
 * -@ExecuteClass: StringGetBytesTest
 * -@ExecuteArgs:
 */
...
public class StringGetBytesTest {
    ...
    public static void StringGetBytesTest_1() {
