 ...
 * -@TestCaseID: StringLastIndexOfIntIntTest.java
 * -@TestCaseName: Test String Method: int lastIndexOf(int ch, int fromIndex).
 * -@TestCaseType: Function Test
 * -@RequirementName: Java字符串实现
 * -@Brief:
 * -#step1: Create String instance.
 * -#step2: Create parameters: ch is ascii numbers, 0 =< fromIndex =< instance.length.
 * -#step3: Test method lastIndexOf(int ch, int fromIndex).
 ...
 * -@Expect: expected.txt
 * -@Priority: High
 * -@Source: StringLastIndexOfIntIntTest.java
 * -@ExecuteClass: StringLastIndexOfIntIntTest
 * -@ExecuteArgs:
 */

import java.io.PrintStream;

public class StringLastIndexOfIntIntTest {
    ...
    public static void StringLastIndexOfIntIntTest_1() {
    ...
    private static void test(String str) {
        // Test fromIndex = 0.
        System.out.println(str.lastIndexOf(49, 0));
        // Test 0 < fromIndex < str.length().
        System.out.println(str.lastIndexOf(49, 3));
        // Test fromIndex = str.length().
        System.out.println(str.lastIndexOf(49, str.length()));
    }
}
