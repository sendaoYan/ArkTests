 ...
 * -@TestCaseID: StringLastIndexOfStringTest.java
 * -@TestCaseName: Test String Method: int lastIndexOf(String str).
 * -@TestCaseType: Function Test
 * -@RequirementName: Java字符串实现
 * -@Brief:
 * -#step1: Create String instance.
 * -#step2: Create parameters: str1 is a letter.
 * -#step3: Test method lastIndexOf(String str).
 ...
 * -@Expect:expected.txt
 * -@Priority: High
 * -@Source: StringLastIndexOfStringTest.java
 * -@ExecuteClass: StringLastIndexOfStringTest
 * -@ExecuteArgs:
 */

import java.io.PrintStream;

public class StringLastIndexOfStringTest {
    ...
    public static void StringLastIndexOfStringTest_1() {
