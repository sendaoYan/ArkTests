 ...
 * -@TestCaseID: UnicodeBlockExObjectnotifyAllIllegalMonitorStateException.java
 * -@TestCaseName: Exception in Character/UnicodeBlock: final void notifyAll()
 ...
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: UnicodeBlockExObjectnotifyAllIllegalMonitorStateException.java
 * -@ExecuteClass: UnicodeBlockExObjectnotifyAllIllegalMonitorStateException
 * -@ExecuteArgs:
 */
