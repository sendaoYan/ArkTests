 ...
 * -@TestCaseID: ReflectPermissionExObjectnotifyIllegalMonitorStateException.java
 * -@TestCaseName: Exception in reflect ReflectPermission:  final void notify()
 ...
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: ReflectPermissionExObjectnotifyIllegalMonitorStateException.java
 * -@ExecuteClass: ReflectPermissionExObjectnotifyIllegalMonitorStateException
 * -@ExecuteArgs:
 */
