 ...
 * -@TestCaseID: ClassLoaderExObjectnotifyIllegalMonitorStateException.java
 * -@TestCaseName: Exception in ClassLoader: final void notify()
 ...
 * -@Expect:0\n
 * -@Priority: High
 * -@Source: ClassLoaderExObjectnotifyIllegalMonitorStateException.java
 * -@ExecuteClass: ClassLoaderExObjectnotifyIllegalMonitorStateException
 * -@ExecuteArgs:
 */
