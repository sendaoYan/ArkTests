 ...
 * -@TestCaseID: ClassInitFieldSetIntInterface
 *- @RequirementName: Java Reflection
 *- @TestCaseName:ClassInitFieldSetIntInterface.java
 *- @Title/Destination: When f is a field of interface OneInterface and call f.setInt(), OneInterface is initialized,
 ...
 *          of OneInterface.
 * -#step2: Call method f.setInt(null, 98), OneInterface is initialized.
 *- @Expect: 0\n
 *- @Priority: High
 *- @Source: ClassInitFieldSetIntInterface.java
 *- @ExecuteClass: ClassInitFieldSetIntInterface
 *- @ExecuteArgs:
 */
