 ...
 *- @TestCaseName:AnnotationConstructorSetTest.java
 *- @TestCaseName: AnnotationConstructorSetTest
 *- @TestCaseType: Function Testing
 *- @RequirementID: AR000D0OR6
  *- @RequirementName: annotation
 *- @Title/Destination: positive test for User-defined Annotation with @Target(ElementType.CONSTRUCTOR)
 *- @Condition: no
 *- @Brief:no:
 * -#step1. User-defined Annotation with @Target(ElementType.CONSTRUCTOR) has field with primitive type, String, ENUM, annotation, class and their array
 * -#step2. verify able to set and get value
 *- @Expect:0\n
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationConstructorSetTest.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationConstructorSetTest
 *- @ExecuteArgs:
 */
