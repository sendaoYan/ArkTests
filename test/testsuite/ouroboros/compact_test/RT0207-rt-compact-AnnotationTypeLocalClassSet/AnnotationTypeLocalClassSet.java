 ...
 *- @TestCaseName:AnnotationTypeLocalClassSet.java
 *- @TestCaseName: AnnotationTypeLocalClassSet
 ...
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationTypeLocalClassSet.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationTypeLocalClassSet
 *- @ExecuteArgs:
 */

import java.util.Arrays;

public class AnnotationTypeLocalClassSet {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        AnnoA anno = Class.forName("AnnotationTypeLocalClassSet$1Test").getAnnotation(AnnoA.class);
        // primitive type
        int i = 0;
