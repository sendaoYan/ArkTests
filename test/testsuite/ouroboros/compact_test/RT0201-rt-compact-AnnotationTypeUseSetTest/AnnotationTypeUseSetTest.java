 ...
 *- @TestCaseName:AnnotationTypeUseSetTest.java
 *- @TestCaseName: AnnotationTypeUseSetTest
 *- @TestCaseType: Function Testing
 *- @RequirementID: AR000D0OR6
  *- @RequirementName: annotation
 *- @Title/Destination: positive test for User-defined Annotation with @Target(ElementType.TYPE_USE)
 *- @Condition: no
 *- @Brief:no:
 * -#step1. User-defined Annotation with @Target(ElementType.TYPE_USE) has field with primitive type, String, ENUM, annotation, class and their array
 * -#step2. verify able to set and get value
 *- @Expect:0\n
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationTypeUseSetTest.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationTypeUseSetTest
 *- @ExecuteArgs:
 */

import java.util.Arrays;

public class AnnotationTypeUseSetTest {
    static int[] passCnt;
