 ...
 *- @TestCaseName:AnnotationTypeInterfaceSetTest.java
 *- @TestCaseName: AnnotationTypeInterfaceSetTest
 ...
 * -#step2. verify able to set and get value on an interface
 *- @Expect:0\n
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationTypeInterfaceSetTest.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationTypeInterfaceSetTest
 *- @ExecuteArgs:
 */

import java.util.Arrays;

public class AnnotationTypeInterfaceSetTest {
