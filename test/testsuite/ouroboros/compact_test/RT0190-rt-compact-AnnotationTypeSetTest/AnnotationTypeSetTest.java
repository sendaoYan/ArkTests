 ...
 *- @TestCaseName:AnnotationTypeSetTest.java
 *- @TestCaseName: AnnotationTypeSetTest
 ...
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationTypeSetTest.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationTypeSetTest
 *- @ExecuteArgs:
 */

import java.util.Arrays;

public class AnnotationTypeSetTest {
