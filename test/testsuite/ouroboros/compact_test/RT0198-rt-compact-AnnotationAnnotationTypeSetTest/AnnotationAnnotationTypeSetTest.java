 ...
 *- @TestCaseName:AnnotationAnnotationTypeSetTest.java
 *- @TestCaseName: AnnotationAnnotationTypeSetTest
 *- @TestCaseType: Function Testing
 *- @RequirementID: AR000D0OR6
  *- @RequirementName: annotation
 *- @Title/Destination: positive test for User-defined Annotation with @Target(ElementType.ANNOTATION_TYPE)
 *- @Condition: no
 *- @Brief:no:
 * -#step1. User-defined Annotation with @Target(ElementType.ANNOTATION_TYPE) has field with primitive type, String, ENUM, annotation, class and their array
 * -#step2. verify able to set and get value
 *- @Expect:0\n
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationAnnotationTypeSetTest.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationAnnotationTypeSetTest
 *- @ExecuteArgs:
 */

import java.util.Arrays;

public class AnnotationAnnotationTypeSetTest {
    static int[] passCnt;
    public static void main(String[] args) {
        AnnoA anno = AnnoB.class.getDeclaredAnnotation(AnnoA.class);
        passCnt = new int[24];
        // 基本数据类型
        int i = 0;
