 ...
 *- @TestCaseName:AnnotationStaticFieldSetTest.java
 *- @TestCaseName: AnnotationStaticFieldSetTest
 ...
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationStaticFieldSetTest.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationStaticFieldSetTest
 *- @ExecuteArgs:
 */

import java.util.Arrays;

public class AnnotationStaticFieldSetTest {
    static int[] passCnt;
