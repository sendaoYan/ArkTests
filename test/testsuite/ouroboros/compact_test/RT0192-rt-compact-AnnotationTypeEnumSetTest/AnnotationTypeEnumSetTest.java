 ...
 *- @TestCaseName:AnnotationTypeEnumSetTest.java
 *- @TestCaseName: AnnotationTypeEnumSetTest
 ...
 * -#step2. verify able to set and get value on an enum class
 *- @Expect:0\n
 *- @Priority: Level 1
 *- @Remark:
 *- @Source: AnnotationTypeEnumSetTest.java AnnoA.java AnnoB.java
 *- @ExecuteClass: AnnotationTypeEnumSetTest
 *- @ExecuteArgs:
 */

import java.util.Arrays;

public class AnnotationTypeEnumSetTest {
